document.getElementById("tac").innerHTML= "Please read these terms of service (\"terms\", \"terms of service\") carefully before using [website] website (the \"service\") operated by [name] (\"us\", 'we\", \"our\").\n" +
    "\n" +
    "Conditions of Use\n" +
    "\n" +
